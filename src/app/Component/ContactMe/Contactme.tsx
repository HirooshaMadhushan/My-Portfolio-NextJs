  ...
  return (
    <div className='bg-slate-900'>
         <div className=' container p-16 '>
            ...
            <div className=" mx-auto p-6  rounded-lg shadow-md w-7/12">
      <form className="space-y-4 ">
        ...
        <div>
          ...
          <textarea
            ...
            className="mt-1 h-52 block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-700 focus:ring-indigo-500 pl-3 bg-slate-800 text-white w-100"
          ></textarea>
        </div>
